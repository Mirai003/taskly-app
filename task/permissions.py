...
class IsAllowedToEditTaskListElseNone(permissions.BasePermission):
    """
    Custom permission for TaskListViewSet to only allow the creator editting permission.
    """
...
class IsAllowedToEditTaskElseNone(permissions.BasePermission):
    """
    Custom permission for TaskViewSet to only allow members of housse access to its tasks.
    """
